...
async function run() {
  try {
    ...
    app.put("/donations/:id", verifyToken, async (req, res) => {
      ...
      const updateDoc = {
        $set: {
          patientName: updateInfo.patientName,
          patientAge: updateInfo.patientAge,
          patientGender: updateInfo.patientGender,
          contactNumber: updateInfo.contactNumber,
          medicalCondition: updateInfo.medicalCondition,
          bloodType: updateInfo.bloodType,
          unitsNeeded: updateInfo.unitsNeeded,
          requiredBy: updateInfo.requiredBy,
          urgency: updateInfo.urgency,
          hospitalName: updateInfo.hospitalName,
          hospitalAddress: updateInfo.hospitalAddress,
          city: updateInfo.city,
          ward: updateInfo.ward,
          contactPerson: updateInfo.contactPerson,
          additionalNotes: updateInfo.additionalNotes,
          agreeTerms: updateInfo.agreeTerms,
          donation_status: updateInfo.donation_status,
